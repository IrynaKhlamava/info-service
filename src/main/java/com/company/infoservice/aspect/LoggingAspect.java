package com.company.infoservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public *  com.company.infoservice.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.company.infoservice.service.*.*.*(..))")
